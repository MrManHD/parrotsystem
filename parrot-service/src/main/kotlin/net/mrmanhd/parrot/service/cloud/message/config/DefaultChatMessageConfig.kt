...
object DefaultChatMessageConfig {
    ...
    private fun getGermanMessages(): Map<String, String> {
        return hashMapOf(
            ...
            Pair("command.creategame.failed.group", "Die ParrotGroup mit dem Namen {0} existiert nicht!"),
            Pair("command.creategame.failed.cloudService", "Der Service mit dem Namen {0} existiert nicht!"),
            Pair("command.creategame.success", "Der ParrotService {0} wird nun gestartet"),
            ...
            Pair("command.restart.failed", "Es werden bereits alle ParrotServices neugestartet!"),
            Pair("command.restart.success", "Alle ParrotServices werden nun gestoppt und werden gleich gestartet"),
            Pair("ingame.command.gotoworld.failed.parrotService", "§cDu bist auf keinem ParrotService!"),
            Pair("ingame.command.parrot.info", "Übersicht über alle Commands§8:"),
            Pair("ingame.command.parrot.send.failed.parrotService", "§cDieser ParrotService existiert nicht!"),
            Pair("ingame.command.parrot.send.failed.playerName", "§cDieser Spielername existiert nicht!"),
            Pair("ingame.command.parrot.send.success", "Du hast §6{0}§7 auf §6{1}§7 gesendet"),
            Pair("ingame.command.parrot.send.from.player", "Du wurdest von §6{0}§7 auf §6{1}§7 gesendet"),
            Pair("ingame.command.parrot.join.success", "Du bist nun auf §6{0}"),
            Pair("ingame.command.parrot.join.failed.parrotService", "§cDieser ParrotService existiert nicht!"),
            Pair("ingame.command.list.failed.daemons", "§cEs sind gerade keine daemons online!"),
    ...
    private fun getEnglishMessages(): Map<String, String> {
        return hashMapOf(
            ...
            Pair("command.creategame.failed.group", "The ParrotGroup with name {0} does not exist!"),
            Pair("command.creategame.failed.cloudService", "The service with name {0} does not exist!"),
            Pair("command.creategame.success", "The ParrotService {0} is now started"),
            ...
            Pair("command.restart.failed", "All ParrotServices are already restarted!"),
            Pair("command.restart.success", "All ParrotServices are now stopped and will be started immediately"),
            Pair("ingame.command.gotoworld.failed.parrotService", "§cYou are not on any ParrotService!"),
            Pair("ingame.command.parrot.info", "Overview of all commands§8:"),
            Pair("ingame.command.parrot.send.failed.parrotService", "§cThis ParrotService does not exist!"),
            Pair("ingame.command.parrot.send.failed.playerName", "§cThis playername does not exist!"),
            Pair("ingame.command.parrot.send.success", "You have sent §6{0}§7 to §6{1}"),
            Pair("ingame.command.parrot.send.from.player", "You were sent from §6{0}§7 to §6{1}"),
            Pair("ingame.command.parrot.join.success", "You are now on §6{0}"),
            Pair("ingame.command.parrot.join.failed.parrotService", "§cThis ParrotService does not exist!"),
            Pair("ingame.command.list.failed.daemons", "§cThere are no daemons online right now!"),
